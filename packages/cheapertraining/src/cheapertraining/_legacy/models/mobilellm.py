...
from cheapertraining._legacy.models.attention import RMSNorm
from cheapertraining._legacy.models.config import MobileLLMConfig
from cheapertraining._legacy.models.transformer import TransformerDecoder
...
class MobileLLM(nn.Module):
    ...
    def from_config(cls, config: Union[MobileLLMConfig, dict, str]) -> "MobileLLM":
        ...
        """
        from cheapertraining._legacy.models.config import get_config
