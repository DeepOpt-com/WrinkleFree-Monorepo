...
class InfluenceTrackerCallback(Callback):
    ...
    Wraps wf_data.influence.InfluenceTracker to integrate with Lightning.
    ...
    def setup(
        ...
        # Only import when needed (wf_data may not be installed)
        try:
            from wf_data.influence import InfluenceTracker
        except ImportError:
            logger.warning(
                "InfluenceTrackerCallback: wf_data.influence not available, "
