...
Requires the wf_data package to be installed.
...
# Import from wf_data (required)
try:
    from wf_data.data import (
    ...
    raise ImportError(
        "wf_data package is required. Install it with: "
...
def create_pretrain_dataloader(
    ...
    **kwargs,
    ...
    """Create pre-training dataloader (delegates to wf_data).
...
def create_mixed_dataloader(
    ...
    **kwargs,
    ...
    """Create mixed pre-training dataloader (delegates to wf_data)."""
    if config is not None:
...
def create_probe_dataloader(
    ...
    **kwargs,
    ...
    """Create probe dataloader (delegates to wf_data)."""
...
__all__ = [
    ...
    "batch_tokenize",
    "compute_position_ids",
    # Legacy factory functions (delegate to wf_data)
