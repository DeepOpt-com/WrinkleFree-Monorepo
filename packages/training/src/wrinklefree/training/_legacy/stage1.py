"""Stage 1: SubLN Insertion - Convert pre-trained model to BitNet architecture."""
...
from wrinklefree.models.bitlinear import BitLinear, convert_linear_to_bitlinear
