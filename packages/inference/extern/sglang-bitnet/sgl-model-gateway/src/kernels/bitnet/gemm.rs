...
use super::gemv_neon::vec_dot_neon;

#[cfg(not(target_arch = "aarch64"))]
use super::gemv_scalar::vec_dot_scalar as vec_dot_neon;
...
fn gemv_parallel(
    ...
    output.par_iter_mut().enumerate().for_each(|(row, out)| {
        ...
        let dot = vec_dot_neon(w_row, activations);
    ...
    output
        ...
        .for_each(|(row, out_row)| {
            ...
            for col in 0..n {
                ...
                let dot = vec_dot_neon(w_row, a_col);
