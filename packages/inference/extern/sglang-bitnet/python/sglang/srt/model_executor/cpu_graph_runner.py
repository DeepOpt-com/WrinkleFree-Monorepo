...
def register_fake_ops():
    ...
    # BitNet-specific ops for 1.58-bit quantization
    ...
    def _(activations):
        return torch.empty_like(activations, dtype=torch.int8), torch.empty(1, dtype=torch.float32, device=activations.device)
