...
from data_handler._legacy.training.scheduler import create_scheduler
from data_handler._legacy.training.stages.base import StageConfig, TrainingStage
...
class Trainer:
    ...
    def setup_stage(
        ...
        from data_handler._legacy.training.stages.midtrain import MidtrainStage
        from data_handler._legacy.training.stages.posttrain import PosttrainSFTStage
